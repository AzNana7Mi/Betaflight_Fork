...
#define PATCH_20260818_DISPLAYPORT_EXTENSION
// 原版有18个通道, 不需要全部传输, 这个在config里面定义
    // 补丁自己用到的通道, 减少通信时间, 用在displayport heartbeat联动传输rc通道
#define PATCH_20260818_MAX_RC_CHANNELS 8
...
#define OSD_FRAMERATE_DEFAULT_HZ 10
...
#define GYRO_1_CS_PIN PA5 //之前是PA5, 片选引脚可以任意选
